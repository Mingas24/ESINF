...
public class Pais implements Comparable<Pais> {
    ...
    /**
     * Método que compara um objecto desta classe com um objecto passado por parâmetro
     *
     * @param o objecto recebido e que vai ser comparado com o desta classe
     * @return true ou false, dependendo de ser igual ao objecto recebido ou não, respectivamente
     */
    @Override
